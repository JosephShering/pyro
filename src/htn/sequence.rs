...
use crate::htn::{BlackboardData, DecomposeType, Plan, blackboard::Blackboard, is_met};
...
#[godot_api]
impl Sequence {
    pub fn decompose(&self, blackboard: BlackboardData) -> DecomposeType {
        let mut operators = Array::new();
        let mut new_blackboard = blackboard.duplicate_deep();
    ...
    pub fn is_met(&self, blackboard: &BlackboardData) -> bool {
